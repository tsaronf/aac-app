...
//     score = 0;
//     items = [
//       ItemModel(value: 'Cat', name: 'Cat'),
//       ItemModel(value: 'Chicken', name: 'chicken'),
//       ItemModel(value: 'Cow', name: 'Cow'),
//       ItemModel(value: 'Dog', name: 'Dog'),
//       ItemModel(value: 'Elephant', name: 'Elephant'),
//       ItemModel(value: 'Giraffe', name: 'Giraffe'),
//       ItemModel(value: 'Goat', name: 'Goat'),
//       ItemModel(value: 'Horse', name: 'Horse'),
//     ];
